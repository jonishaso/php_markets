...
class ctl_mamform extends cmsPage
{
	...
	function index_action() {
		if ( is_post() ) {
			...
			$mdl_contact = $this->loadModel( 'mamContact' );
			if ( $mdl_contact->insert( array( 'name' => $name, 'email' => $email, 'telephone' => $telephone, 'message' => $message, 'subscribe' => $subscribe, 'country'=>$country, 'area' => $area, 'createtime' => time() ) ) ) {
