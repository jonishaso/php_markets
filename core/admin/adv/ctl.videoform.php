...
/*
 @ctl_name = videoform管理@
*/

class ctl_videoform extends adminPage
{

	public function index_action () #act_name = videoform列表#
	{
		date_default_timezone_set('Australia/Sydney');
		$bllLink	= $this->loadModel('videoform');
		$where		= "";
	...
	public function edit_action () #act_name = videoform回复#
	{
		$id			= (int)get2('id');
		$bllLink	= $this->loadModel('videoform');
		$data		= $bllLink->get($id);
	...
	public function delete_action () #act_name = 删除videoform#
	{
		if (is_post())
		{
			$ids = post('ids');
