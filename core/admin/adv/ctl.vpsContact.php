...
/*
 @ctl_name = vpsContact管理@
*/

class ctl_vpsContact extends adminPage
{

	public function index_action () #act_name = vpsContact列表#
	{
		date_default_timezone_set('Australia/Sydney');
		$bllLink	= $this->loadModel('vpsContact');
		$where		= "";
	...
	public function edit_action () #act_name = vpsContact回复#
	{
		$id			= (int)get2('id');
		$bllLink	= $this->loadModel('vpsContact');
		$data		= $bllLink->get($id);
	...
	public function delete_action () #act_name = 删除vpsContact#
	{
		if (is_post())
		{
			$ids = post('ids');
