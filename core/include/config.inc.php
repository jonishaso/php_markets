...
//模板
define( 'LANGS', serialize( array( array( 'id' => 'en', 'name' => 'English' ), array( 'id' => 'zh-cn', 'name' => '简体中文' ) ) ) );
...
if ( ! empty( $lang ) ) {
	...
	// if(getCookie('lang')=='en'|| getCookie('lang')=='zh-cn')
...
$camp = trim( $_GET['camp'] );
setcookie( 'camp', $camp, time() + 24 * 60 * 60 );
